...
def gen_blocks():
    ...
    realblocklist.append((2,4))
    realblocklist.append((2,5))
    realblocklist.append((2,6))
    realblocklist.append((2,7))
    realblocklist.append((2,3))
    realblocklist.append((19,1))
    realblocklist.append((19,2))
    realblocklist.append((20,1))
    realblocklist.append((20,2))
    for i in range(2,18):
        for j in range(1,3):
            realblocklist.append((i,j))
    for i in range(5,17):

        realblocklist.append((20,i))
    # realblocklist.remove((7,3))
    # realblocklist.remove((8,3))
    for i in range(7,17):
        for j in range(19,21):
            realblocklist.append((i,j))

    for i in range(14,20):
            realblocklist.append((2,i))

    for i in range(5,19):
        for j in range(7,15):
            realblocklist.append((i,j))

    realblocklist.append((4,10))
    realblocklist.append((4,9))
    realblocklist.append((4,12))
    realblocklist.append((4,13))
    realblocklist.append((3,5))
    realblocklist.append((1,3))
    realblocklist.append((1,4))
    realblocklist.append((1,5))

    realblocklist.append((1,16))
    realblocklist.append((1,17))
    realblocklist.append((1,18))
    realblocklist.append((1,20))
    realblocklist.append((2,20))
    realblocklist.append((1,19))
    realblocklist.append((1,14))
    realblocklist.append((1,15))
    realblocklist.append((1,6))
    realblocklist.append((1,7))
    realblocklist.append((3,6))
    realblocklist.append((5,3))
    realblocklist.append((6,3))
    realblocklist.append((9,3))
    realblocklist.append((10,3))
    realblocklist.append((11,3))
    realblocklist.append((12,3))
    realblocklist.append((15,3))
    realblocklist.append((16,3))
    realblocklist.append((3,19))
    realblocklist.append((9,18))
    realblocklist.append((10,18))
    realblocklist.append((14,18))
    ...
    realblocklist.append((19,19))
    realblocklist.append((7,15))
    realblocklist.append((8,15))
    realblocklist.append((11,15))
    realblocklist.append((12,15))
    realblocklist.append((15,15))
    realblocklist.append((16,15))

    realblocklist.append((8,6))
    realblocklist.append((9,6))
    realblocklist.append((12, 6))
    realblocklist.append((13, 6))
    realblocklist.append((15, 6))
    realblocklist.append((16, 6))
    realblocklist.append((18, 17))
    realblocklist.append((18, 16))
    # realblocklist.append((18, 15))
